...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TranslateModule, RouterLink, BreadcrumbsComponent, SliderComponent, ShareComponent, FormatTextPipe, FadeInCarouselComponent, SafeHtmlPipe, ContentTextComponent],
